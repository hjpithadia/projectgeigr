package com.example.hirshjaykrishnan.projectgeigr;
...
public class MainActivity extends Activity implements View.OnClickListener{
    ...
    Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case Bluetooth.MESSAGE_READ:
                    ...
                    Log.d("DArduino", writeMessage);



                    //Plotting the Value
                    Series.appendData(new GraphViewData(graph2LastXValue, Double.parseDouble(writeMessage)), AutoScrollX);

                    //X-axis control and scroll refresh

                    if (graph2LastXValue >= Xview && Lock == true) {
                        Series.resetData((new GraphViewData[]{}));
                        graph2LastXValue = 0;
                    } else graph2LastXValue += 1;
        ...
        //private double average(double btdata) {
          //  double sum = 0;
           // double average;
    ...
    void init(){
        ...
        Series = new GraphViewSeries("Counts",
                new GraphViewStyle(Color.LTGRAY, 2),//color and thickness of the line
                new GraphViewData[] {new GraphViewData(0, 0)});
        graphView = new LineGraphView(
                this // context
                , "Radiation Activity" // heading
        );
        ...
        graphView.setManualYAxisBounds(25, 0);
